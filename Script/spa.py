...
appeal_texts = {
    ...
    "People": """Consulte la información
detallada de los
reclamos en las
...
""",
    ...
    "SPANet": "Consulte la información detallada de los reclamos en las páginas siguientes o visite directamente PCNhealth.com para verlos.",

    "SPAPrefferedCare": "Consulte la información detallada de los reclamos en las páginas siguientes o visite directamente myPreferredCare.com para verlos.",
    
    "SPIR": "[IR_170224_155359]",

    "WithoutNOS": """Si tomaremos""",

    "LogoRemove": """llámenos al: 1-800-496-5841"""

    #"LogoRemoveN": """llámenos al: 1-866-480-1086"""
}
...
macro_maps = {
    ...
    "WithoutNOS": {
        "[insert_QR": "SUHC",
        "USTED TIENE DERECHO A APELAR NUESTRA DECISIÓN": "SPWithoutNOS",
        #"[insert_keyterms]": "keytable",
        "[insert_DenialCodeDescription]": "DenS"
    },
    "People": {
        "[insert_QR": "UHCAdv",
        "USTED TIENE DERECHO A APELAR NUESTRA DECISIÓN": "SPAPeople",
        #"[insert_keyterms]": "keytable",
        "[insert_DenialCodeDescription]": "DenS"
    },
    "IDN": {
    ...
    "SPIR": {
        "Consulte la información": "SPUHC",
        "USTED TIENE DERECHO A APELAR NUESTRA DECISIÓN": "SPAIRPCP",
        "E": "Logo",
        "[insert_DenialCodeDescription]": "DenS"
    },
    #"SPIRPCP": {
    ...
    #"SPIRPCN": {
        #"Consulte la información": "SPUHC",
        #"USTED TIENE DERECHO A APELAR NUESTRA DECISIÓN": "SPAIRPCN",
        #"E": "Logo",
        #"[insert_DenialCodeDescription]": "DenS"
    #},
    "LogoRemove": {
        "E": "Logo",
        "Consulte la información": "SPUHC",
        "USTED TIENE DERECHO A APELAR NUESTRA DECISIÓN": "SPAfour",
        "[insert_DenialCodeDescription]": "DenS"
    }
    #"LogoRemoveN": {
        #"E": "Logo",
        #"Consulte la información": "SPUHC",
        #"USTED TIENE DERECHO A APELAR NUESTRA DECISIÓN": "SPAfourN",
        #"[insert_DenialCodeDescription]": "DenS"
    #}
}
...
def process_all_files_in_folder(folder_path):
    ...
    for pdf_file in pdf_files:
        ...
        for key in ["SPIR", "People", "SPANet", "SPAPrefferedCare", "LogoRemove", "WithoutNOS", "SPA0356"]:
        ...
        if not pdf_type:
            ...
            #pcp_text = appeal_texts["SPAPrefferedCare"].replace('\n', ' ').strip()
            #pcn_text = appeal_texts["SPANet"].replace('\n', ' ').strip()
            #IR_text = appeal_texts["SPAIR"].replace('\n', ' ').strip()
